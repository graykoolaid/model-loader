...
{		
	D3DXMATRIX pm;
	D3DXMatrixPerspectiveFovLH( &lightProjMatrix, XM_PIDIV4, 4.0f/3, 20.0f, 100.f );

	D3DXVECTOR3 o = D3DXVECTOR3(0,0,0);
	D3DXVECTOR3 up = D3DXVECTOR3(0,1,0);
	D3DXVECTOR3 e = vLightDirs[0];
	D3DXVECTOR3 fp = o;
	D3DXVECTOR3 u = up;
	D3DXMATRIX vm;
	D3DXMatrixLookAtLH( &vm, &e, &fp, &u );
	D3DXMatrixMultiply( &lightViewProjMatrix, &vm, &pm );

	g_pLightViewProjMatrix->SetMatrix( lightViewProjMatrix );
}
//---------------------------------------------------------------------------------------
